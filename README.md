...
* **클론하시어, 원하는 프로그램의 port번호를 하드코딩 하는 편을 추천합니다.**
...
- **에이전트 점검**: 로컬 DRM Agent 포트(7777/8443/9443/7443/등 타겟 프로그램의 포트-추후 입력 가능하게 변경 예정) 연결 확인
...
- 방화벽/보안 프로그램이 포트(7777/8443/9443/7443/등 타겟 프로그램의 포트-추후 입력 가능하게 변경 예정)를 막지 않는지 확인
